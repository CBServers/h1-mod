...
namespace nat
{
	namespace
	{
		...
		void set_hosting_enabled(bool enabled)
		{
			...
			if (nat_open_dvar)
			{
				...
				game::Dvar_SetVariant(nat_open_dvar, &value, game::DVAR_SOURCE_INTERNAL);
			}
	...
	public:
		void post_unpack() override
		{
			...
			scheduler::once([]
			{
				rendezvous_ip = dvars::register_string("rendezvousServerIP", "master.cbservers.xyz",
					game::DVAR_FLAG_NONE, "Rendezvous server for NAT hole punching");
				rendezvous_port = dvars::register_string("rendezvousServerPort", "20810",
				...
				auto_open_dvar = dvars::register_bool("nat_autoOpen", false,
